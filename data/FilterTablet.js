  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        ...
        <label className="block text-xs md:text-sm"><input type="checkbox" className="mr-2" /> Huawei (9)</label> {/* Añadido text-xs en móviles */}
        <label className="block text-xs md:text-sm"><input type="checkbox" className="mr-2" /> Lenovo (5)</label> {/* Añadido text-xs en móviles */}
      </div>
      <div className="mb-4">
        ...
        <label className="block text-xs md:text-sm"><input type="checkbox" className="mr-2" /> Windows (7)</label> {/* Añadido text-xs en móviles */}
        <label className="block text-xs md:text-sm"><input type="checkbox" className="mr-2" /> HarmonyOS (5)</label> {/* Añadido text-xs en móviles */}
      </div>
      <div className="mb-4">
        ...
        <label className="block text-xs md:text-sm"><input type="checkbox" className="mr-2" /> LTE (10)</label> {/* Añadido text-xs en móviles */}
        <label className="block text-xs md:text-sm"><input type="checkbox" className="mr-2" /> 5G (9)</label> {/* Añadido text-xs en móviles */}
        <label className="block text-xs md:text-sm"><input type="checkbox" className="mr-2" /> Bluetooth (5)</label> {/* Añadido text-xs en móviles */}
      </div>
      <div className="mb-4">
...
export default FilterBoxTabletas;